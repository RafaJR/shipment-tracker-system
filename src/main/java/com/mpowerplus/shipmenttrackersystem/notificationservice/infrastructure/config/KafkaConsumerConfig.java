package com.mpowerplus.shipmenttrackersystem.notificationservice.infrastructure.config;
...
/**
 * Kafka Consumer configuration for consuming shipment status change events.
 */
@Configuration
@EnableKafka
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ShipmentStatusChangedEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ShipmentStatusChangedEvent.class.getName());
